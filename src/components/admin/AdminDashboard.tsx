...
const AdminDashboard: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: 'user-deposits', label: 'Depósito Users', shortLabel: 'Depósitos', icon: <DollarSign size={20} /> },
  ...
  return (
    <div className="container mx-auto py-4 md:py-6 max-w-7xl px-2 md:px-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        {/* Mobile layout - adjusted for 7 items */}
        {isMobile ? (
        ...
        <TabsContent value="user-deposits" className="mt-0">
          <ErrorBoundary tabName="Depósito Users">
            <UserDeposits />
          </ErrorBoundary>
        </TabsContent>
